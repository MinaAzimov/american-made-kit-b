var settings = {
	...
	initialManifest : {
		...
		manifest : [
			...
			{ id : "dougliman_overlay", src : "img/_castncrew/overlay_dougliman.jpg", crossOrigin : true },
			{ id : "garyspinelli_overlay", src : "img/_castncrew/overlay_garyspinelli.jpg", crossOrigin : true },
