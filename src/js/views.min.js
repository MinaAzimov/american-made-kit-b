homeView = function(e, t) {
    ...
    populate: function() {
            ...
            $("#story7").css("background-image", "url('" + app.preloader.getAsset("story7bg").src + "')"), "mobile" !== this.device ? ( $("#story2").vide(app.preloader.getAsset("story3vid").src, {
            posterType: "jpg",
            autoplay: !0,
            loop: !0
        })) : ($("#story2").css("background-image", "url(" + app.preloader.getAsset("story2bg_mob").src + ")")),
    ...
    updateFixedValues: function() {
                ...
                for(this.scenes[0].offset(document.getElementById("story1").clientHeight/4),
