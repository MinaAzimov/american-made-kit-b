        ...
        if ("desktop" === this.device || "tablet" === this.device)
            for ($("#castncrew-header").html('<div class="cover"><img src="' + 
                ...
                this.split = !1, $(".cnc_split").append('<div id="cnc_' + data.castncrew.list[i].label + '" class="cnc_' + data.castncrew.list[i].type + '"><div class="cover cnc_cover"><img src="' + 
                    ...
                    data.castncrew.list[i].role + '</h1>' + '<div class="cnc_quote"><div><div class="divider"></div><div class="btn_scroll"><div class="btn_scroll_outer"><div class="btn_scroll_middle"><div class="btn_scroll_inner"></div></div></div><h1 class="btn_scroll_text">“</h1></div><div class="divider"></div></div><p>' + data.castncrew.list[i].quote + '</p></div>' +
                   '</div></div></li>');
