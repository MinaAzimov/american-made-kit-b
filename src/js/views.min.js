homeView = function(e, t) {
    ...
    intro: function() {
        ...
        var count = function(){
            if (parseInt($('#preloader-loading-text').text(), 11) < 100) {
                $('#preloader-loading-text').text((parseInt($('#preloader-loading-text').text(), 11)+1));
                console.log($('#preloader-loading-text').text());
