homeView = function(e, t) {
    ...
    init: function() {
        ...
        }), app.browserCheckFireFox(), this.addYoutubeVideo(), 
        ...
        $("#videos-list-mobile li.video_active").click(function() {
            ...
            switch (t) {
                case 0:
                    ...
                    break;
                case 1:
                    console.log(1), app.dispatcher.dispatch("CUE_PLAYLIST_INDEX", 2);
                    break;
                case 2:
                    console.log(2), app.dispatcher.dispatch("CUE_PLAYLIST_INDEX", 1);
                    break;
        ...
        $("#safari-page").delegate("#tout_trailer-safari", "click", function() {
            var e = Array.prototype.slice.call(document.getElementById("videos-list").children),
                t = e.indexOf(this);
                    console.log(0), app.dispatcher.dispatch("CUE_PLAYLIST_INDEX", 0);
            app.dispatcher.dispatch("SHOW_TRAILER")
        }),
         "mobile" != Detectizr.device.type ? this.initPreload() : (this.initPreloadMobile(), $("#splash").show(), $("#safari-page").css('display', 'none'), $("body").removeClass("noscroll"), window.location.hash="home-mobile"),
    ...
    addYoutubeVideo: function() {
        var e = {
            ...
            t = {
                ...
                id: "PLuq_rgCzEP_N9cxPd5BAQInvFGHGwNcsG", 
                closeBtn: "yt-close",
                list: !0,
                index: 0,
                showinfo: 0,
    ...
    onLoaded: function(e, t) {
       app.browserCheck(), this.outro(), this.dispatcher.removeEventlistener(this.progressEvent), this.dispatcher.removeEventlistener(this.completeEvent),
           imageAnimation = function() {
                ...
                var headline8 = document.querySelector('.trigger-headline8');
                var headline9 = document.querySelector('.trigger-headline9');
                var headline10 = document.querySelector('.trigger-headline10');
                var headline11 = document.querySelector('.trigger-headline11');
                ...
                setTimeout(function() {
                    ...
                    headline6.classList.remove('trigger-headline6--hidden');
                    headline7.classList.remove('trigger-headline7--hidden');
                    headline8.classList.remove('trigger-headline8--hidden');
                    headline9.classList.remove('trigger-headline9--hidden');
                    headline10.classList.remove('trigger-headline10--hidden');
                    headline11.classList.remove('trigger-headline11--hidden');
                }, 1000);    
            },
        imageAnimation(); 
    ...
    createNavScene: function(e, t, s, o, n, a) {
        var e = new ScrollMagic.Scene({
            ...
            TweenMax.fromTo($("#tickets-cta3"), 0, {
                className: 'active'
            }, {
                className: ''
            }),
            TweenMax.fromTo($("#tickets-cta4, #tickets-cta5"), 0, {
                className: 'active'
            }, {
                className: ''
            })
