homeView = function(e, t) {
    ...
    populate: function() {
            ...
            autoplay: !0,
            loop: !0
        }), $("#story2").vide(app.preloader.getAsset("story3vid").src, {
            posterType: "jpg",
            autoplay: !0,
            loop: !0
         ...
         "desktop" == this.device ? tween1_1=TweenMax.fromTo(".s1_text1", .5, {
            ...
            ease: Power2.easeInOut
                    ...
                    tween6_1 = new TimelineMax, tween6_1.fromTo("#s6_text", 0.5, {
            opacity: 0
        }, {
            opacity: 1,
            ease: Power4.easeInOut
        ...
        this.createScene("story6_1", document.getElementById("story6").clientHeight / 25,  0, tween6_1, "story6"), 
    ...
    updateFixedValues: function() {
                ...
                for(this.scenes[1].offset(document.getElementById("story1").clientHeight/4),
                  this.scenes[1].duration(document.getElementById("story1").clientHeight-1.25*window.innerHeight),
                    ...
                    this.scenes[5].offset(-0.5* (document.getElementById("story6").clientHeight )),
                     this.scenes[6].offset(-1 * (document.getElementById("story6").clientHeight-1.15*window.innerHeight)),
                     this.scenes[6].duration(1.5 * document.getElementById("s1_text2").clientHeight),
        ...
        if ("desktop" === this.device || "tablet" === this.device)
            for ($("#castncrew-header").html('<div class="cover"><img src="' + 
                ...
                this.split = !1, $(".cnc_split").append('<div id="cnc_' + data.castncrew.list[i].label + '" class="cnc_' + data.castncrew.list[i].type + '"><div class="cover cnc_cover"><img src="' + 
                    ...
                    data.castncrew.list[i].role + '</h1>' + '<div class="cnc_quote"><div><div class="divider"></div><div class="btn_scroll"><div class="btn_scroll_outer"><div class="btn_scroll_middle"><div class="btn_scroll_inner"></div></div></div><h1 class="btn_scroll_text"><i class="am-icon am-icon-quote"></i></h1></div><div class="divider"></div></div><p>' + data.castncrew.list[i].quote + '</p></div>' +
                   '</div></div></li>');
