homeView = function(e, t) {
    ...
    init: function() {
        ...
        if("desktop" !== app.device && "opera mobi" == app.browser && this.onIOSdevice(app.device)) {
          this.initPreloadMobile(), $("#splash").show(), $("#safari-page").css('display', 'none'), $("body").removeClass("noscroll"), window.location.hash="home-mobile"  
        }
    },
    ...
    switch (app.browser) {
            ...
            "mobile" !== app.device &&
               ...
               if(width < 767 && "mobile" !== app.device) {
               $( "#safari-page" ).hide();
               $("#safari-page").css('display', 'none');
               $( "#splash" ).show();
               }
               if(width > 767 && "mobile" !== app.device) {
               $( "#safari-page" ).show();
