        ...
        switch (app.browser) {
            case "firefox":
               ...
               $("#s1_fg_video").attr("src", "img/videos_mobile_bg.jpg");
                $("#s1_fg_video").attr("type", "img/jpg");
                 $("#s1_fg").css("display", "block");
                $("#story_text1").removeClass('trigger-headline--hidden');
                  $("#story_text2").removeClass('trigger-headline1--hidden');
                  $("#story_text3").removeClass('trigger-headline2--hidden');
                 $("#story_text4").removeClass('trigger-headline3--hidden');
                break;
            default:
