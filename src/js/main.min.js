var app = {
    ...
    init: function() {
        ...
        app.ticketsView = new ticketsView(app.dispatcher), app.ticketsView.init(), app.browserMute(), app.dateCheck(), app.bindEvents(), app.resize();
        window.innerWidth;
    ...
    loadHome: function () {
       ...
       $("#safari-page").load("external.html");
      ...
      switch (app.browser) {
            ...
            "mobile" !== app.device &&
               $("#s1_fg_video").attr("src", "img/videos_mobile_bg.jpg");
                ...
                break;
               case "safari":
               "mobile" !== app.device && app.loadHome();
               break;
                case "ie":
                "mobile" !== app.device && $("#safari-page").hide();
                 $("#main").show();
    ...
    browserCheck: function() {
       switch (app.browser) {
            case "chrome":
                ...
                break;
            case "firefox":
                app.version <= 44 && $("#upgrade").css("display", "block");
                break;
            case "safari":
